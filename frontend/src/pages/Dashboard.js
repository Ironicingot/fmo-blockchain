...
export default class Dashboard extends React.Component {
   ...
   */
  render() {
    const { currentUser, currentUSD, userValue, portfolio, prices } =
      this.state;
              ...
              <Card className="h-100 bg-dark">
                ...
                <ListGroup variant="flush" className="h-88">
                  <ListGroup.Item
                    action
                    href="/btc"
                    className="h-9 text-light bg-dark"
                  >
                  ...
                  <ListGroup.Item className="h-10 d-flex justify-content-center align-items-center bg-dark">
